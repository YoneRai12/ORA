...
class Flux(nn.Module):
    ...
    def __init__(self, image_model=None, final_layer=True, dtype=None, device=None, operations=None, **kwargs):
        ...
        # ORA FORCE PATCH: Override Hidden Size and Axes Dim for Dev Model
        if kwargs.get("hidden_size") == 3072:
            kwargs["hidden_size"] = 6144
            kwargs["axes_dim"] = [32, 112, 112]  # Match pe_dim=256
