    ...
    async def load_model(self):
        ...
        try:
            ...
            try:
                ...
                self.vocoder = (
                    XCodec2Model.from_pretrained("NandemoGHS/Anime-XCodec2-44.1kHz-v2", trust_remote_code=True)
                    .to(self.device)
                    .eval()
                )
            except ImportError:
                ...
                try:
                    ...
                    self.vocoder = (
                        AutoModel.from_pretrained("NandemoGHS/Anime-XCodec2-44.1kHz-v2", trust_remote_code=True)
                        .to(self.device)
                        .eval()
                    )
            ...
            def _run_sync():
                ...
                with torch.no_grad():
                    ...
                    audio_values, _ = self.model.inference_tts(
                        x=input_ids, x_lens=x_lens, y=y, tgt_y_lens=tgt_y_lens, top_k=50, top_p=1.0, temperature=0.8
                    )
