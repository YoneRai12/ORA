...
class SelectModeView(View):
    def __init__(self, cog, user_id: int):
        super().__init__(timeout=None) # Persistent view context usually needed, but for ephemeral interaction None is ok if handled quickly.
        self.cog = cog
    ...
    @discord.ui.button(label="Private 🔒 (Local Only)", style=discord.ButtonStyle.secondary, custom_id="onboard_private")
