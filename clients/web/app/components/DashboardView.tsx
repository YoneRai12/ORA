...
export default function DashboardView({ guildId, guildName }: DashboardViewProps) {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#0a0a0c] text-cyan-500 flex items-center justify-center font-mono">
                <div className="animate-pulse">INITIALIZING SYSTEM MONITOR FOR {guildName}...</div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-[#0a0a0c] text-gray-300 font-sans p-8">
            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center mb-12">
                ...
                <div className="flex gap-4">
                    <Link
                        href="/dashboard"
                        className="px-6 py-2 border border-white/20 text-white/70 hover:bg-white/10 transition-all text-xs font-mono uppercase tracking-widest"
                    >
                        Switch Server
                    </Link>
                    <Link
